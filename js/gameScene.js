class GameScene extends Phaser.Scene {
    ...
    create() {
        ...
        //add circle
        this.circle = this.add.image(config.width/2, config.height / 4 + 80, 'circle');
        this.circle.setScale(.07);

        //ad dot
        this.dot = this.add.image(this.stump.x, this.stump.y, 'dot');
        this.dot.setScale(.8);
        this.dot.depth = -1;

        //hide ball
        this.hideBall = this.physics.add.image(this.circle.x, this.circle.y, 'ball');
    ...
    dotMoveRight() {
        ...
        this.dot = this.add.image(this.stump.x + 18, this.stump.y, 'dot');
        this.dot.setScale(.8);
        this.dot.depth = -1;
    ...
    dotMoveLeft() {
        ...
        this.notOut = true;
        this.dot.visible = false;
        this.dot = this.add.image(this.stump.x-40, this.stump.y, 'dot');
        this.dot.setScale(.8);
        this.dot.depth = -1;
    ...
    update() {
        ...
        if (this.fullTouch) {
            ...
            // for move ball
            if (!this.click && this.bolean && this.ball.y <= 230) {
                this.myCalculation.call(this);
                this.bolean = false;
        ...
        // for bounce ball
            ...
            if (!this.click && this.bolean && this.bounceBall.y <= 230) {
                this.myCalculation.call(this);
                this.bolean = false;
